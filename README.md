...
| 文档 | 描述 |
|------|------|
| **[README.md](./README.md)** | 项目索引和快速开始(本文件) |
...
- [React并发模式](https://react.dev/learn/concurrent-ui-patterns)
- [localStorage最佳实践](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage)
- [BroadcastChannel API](https://developer.mozilla.org/en-US/docs/Web/API/BroadcastChannel)

### 相关项目
- [React状态管理对比](https://github.com/reactjs/react-redux)
- [跨页签通信方案](https://developer.mozilla.org/en-US/docs/Web/API/BroadcastChannel)
